...
import { Fps } from '../fps';
import { Scalable } from '@app/components/scalable';
    ...
    public render() {
        ...
        return (
            <div class={style.container} style={{
                ...
                <div ref={this._gameRef} class={style.console} style={{
...
export const Console = connectStoreon('settings', ConsoleComponent);
